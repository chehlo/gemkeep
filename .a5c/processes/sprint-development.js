  ...
  agent: {
    ...
    prompt: {
      ...
      task: [
        ...
        'Score it 0-100 based on the following criteria (5 dimensions, 20 points each):',
        '',
        'GOAL CLARITY (0-20):',
        ...
        '- Do the features form a coherent unit or are they unrelated changes bundled together?',
        '- Is there a clear "done" definition from the user perspective (not just technical criteria)?',
        '',
        'COMPLETENESS (0-20):',
      ...
      instructions: [
        `Read: ${args.sprintSpecPath}`,
        `Read: ${args.sprintPlanPath}`,
        'Score each of the 5 dimensions (0-20 each)',
      ...
      outputFormat: 'JSON with score (number 0-100), goalClarityScore (number 0-20), completenessScore (number 0-20), testabilityScore (number 0-20), architectureScore (number 0-20), implementabilityScore (number 0-20), gaps (array of string), missingElements (array of string), recommendations (array of string), summary (string)',
    },
    outputSchema: {
      type: 'object',
